class Solution:
    def findMaximizedCapital(self, k: int, w: int, profits: List[int], capital: List[int]) -> int:
        ...
        while k != 0 :
            while i < len(Prof_Cap) and current_capital >= Prof_Cap[i][1]  and (Prof_Cap[i][0], Prof_Cap[i][1]) not in visit:
            ...
            visit.add((-profit, cap))
            print("The current visit set is :", visit)
